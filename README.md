...
1. **Clone the repository**: 
   ```bash
   git clone [https://github.com/82ychitx/libsig](https://github.com/82ychitx/libsig)
   ```
...
You can save this script as `plot_benchmarks.m` inside your `matlab/` directory and run it to generate the `benchmark_plot.png` image used above.
...
subplot(2, 2, 4);
b = bar(functions, [medium_10m_mat
